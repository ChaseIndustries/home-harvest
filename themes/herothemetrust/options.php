...
function optionsframework_options() {	
	...
	$options[] = array( "name" => __('Logo','themetrust'),
						...
						"type" => "upload");
							...
							$options[] = array( "name" => __('Facebook Share Logo','themetrust'),
						"desc" => __('Upload a custom facebook share image.','themetrust'),
						"id" => "fb_logo",
						"type" => "upload");
	...
	$options[] = array( "name" => __('Banner Image','themetrust'),
						...
						"id" => "ttrust_home_banner_img1",
						"type" => "upload");
						
						$options[] = array( "name" => __('Banner image alignment 1','themetrust'),
						"desc" => __('','themetrust'),
						"id" => "ttrust_home_banner_img1_align",
						"std" => "",
						"type" => "select",
						"options"=>array("align_top"=>"Align Top","align_middle"=>"Align Middle","align_bottom"=>"Align Bottom"));
	$options[] = array( "name" => __('Banner image text 1','themetrust'),
						"desc" => __('Text to go with the first banner','themetrust'),
						"id" => "ttrust_home_banner_img1_text",
						"std" => "",
						"type" => "text");
						
	$options[] = array( "name" => __('Banner Image 2','themetrust'),
	"desc" => __('Upload an image for the home page banner. Recommended dimensions: 1200px x 590px','themetrust'),
	"id" => "ttrust_home_banner_img2",
	"type" => "upload");
	$options[] = array( "name" => __('Banner image alignment 2','themetrust'),
						"desc" => __('','themetrust'),
						"id" => "ttrust_home_banner_img2_align",
						"std" => "",
						"type" => "select",
						"options"=>array("align_top"=>"Align Top","align_middle"=>"Align Middle","align_bottom"=>"Align Bottom"));
	$options[] = array( "name" => __('Banner image text 2','themetrust'),
						"desc" => __('Text to go with the second banner','themetrust'),
						"id" => "ttrust_home_banner_img2_text",
						"std" => "",
						"type" => "text");
	
	$options[] = array( "name" => __('Banner Image 3','themetrust'),
	"desc" => __('Upload an image for the home page banner. Recommended dimensions: 1200px x 590px','themetrust'),
	"id" => "ttrust_home_banner_img3",
	"type" => "upload");
		$options[] = array( "name" => __('Banner image alignment 3','themetrust'),
						"desc" => __('','themetrust'),
						"id" => "ttrust_home_banner_img3_align",
						"std" => "",
						"type" => "select",
						"options"=>array("align_top"=>"Align Top","align_middle"=>"Align Middle","align_bottom"=>"Align Bottom"));
	$options[] = array( "name" => __('Banner image text 3','themetrust'),
						"desc" => __('Text to go with the third banner','themetrust'),
						"id" => "ttrust_home_banner_img3_text",
						"std" => "",
						"type" => "text");
	
	$options[] = array( "name" => __('Banner Image 4','themetrust'),
	"desc" => __('Upload an image for the home page banner. Recommended dimensions: 1200px x 590px','themetrust'),
	"id" => "ttrust_home_banner_img4",
	"type" => "upload");
	$options[] = array( "name" => __('Banner image alignment 4','themetrust'),
						"desc" => __('Text to go with the fourth banner','themetrust'),
						"id" => "ttrust_home_banner_img4_align",
						"std" => "",
						"type" => "select",
						"options"=>array("align_top"=>"Align Top","align_middle"=>"Align Middle","align_bottom"=>"Align Bottom"));
	
	$options[] = array( "name" => __('Banner image text 4','themetrust'),
						"desc" => __('Text to go with the fourth banner','themetrust'),
						"id" => "ttrust_home_banner_img4_text",
						"std" => "",
						"type" => "text");
	...
	$options[] = array( "name" => __('Secondary Banner Text','themetrust'),
						...
						"type" => "textarea");
	$options[] = array( "name" => __('Home Page Text','themetrust'),
						"desc" => __('Enter the text that will appear on the homepage under the banner.','themetrust'),
						"id" => "ttrust_home_text",
						"std" => "A little about ourselves",
						"type" => "textarea");
	...
	$options[] = array( "name" => __('Right Footer Text','themetrust'),
						...
						"std" => "",
						"type" => "textarea");
	$options[] = array( "name" => __('Footer Image','themetrust'),
						"desc" => __('This will be the background image for the footer.','themetrust'),
						"id" => "ttrust_footer_image",
						"std" => "",
						"type" => "upload");
