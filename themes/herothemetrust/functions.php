...
<?php if ($heading_font) : ?>
	h1, h2, h3, h4, h5, h6 { font-family: '<?php echo $heading_font; ?>' !important; }
<?php endif; ?>
<?php if ($body_font) : ?>
...
<?php if(of_get_option('ttrust_banner_text_position')) : ?>
	.home_text { top: <?php echo(of_get_option('ttrust_banner_text_position')); ?>px; }
<?php endif; ?>
...
<?php if(of_get_option('ttrust_color_menu')) : ?>#mainNav ul a, #mainNav ul li.sfHover ul a { color: <?php echo(of_get_option('ttrust_color_menu')); ?>;	}<?php endif; ?>
...
<?php if(of_get_option('ttrust_color_menu_hover')) : ?>
	...
	#mainNav ul li.current-projects-ancestor a {
		color: <?php echo(of_get_option('ttrust_color_menu_hover')); ?>;		
	}
...
set_post_thumbnail_size(300, 187, true);
...
add_image_size('ttrust_one_third_cropped_lg', 400, 233, true);
