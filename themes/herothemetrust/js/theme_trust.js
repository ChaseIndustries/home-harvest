...
/*    jQuery('#bannerText').css({
	...
	//see if banner is past the bottom
	var b = jQuery("#header").height();
	jQuery(".bg_image").each(function(){
		var r = Math.abs(b-jQuery(this).height());
		if(b > jQuery(this).height()){ return }
		var amount = defMargin[jQuery(this).index(".bg_image")]-(scrollPos/2);
		if(Math.abs(amount)<=r){
			jQuery(this).css({
